<?php
	...
	koneksi();
?>
<form id="defaultForm" class='form-horizontal' method='post' action='modul/mod_detail_guru/act.php?act=tambah' id='frm' enctype='multipart/form-data' autocomplete='off' >
	<div class="row">
		<div class="col-lg-8">
	        ...
	        <div class="form-group">
			    ...
			    <div class="col-lg-8">
		            <select class="form-control" name="mapel" tabindex="12">
		              	...
		              	<?php
					    	$selectMapelvii = mysql_query("SELECT * FROM tbl_data_mapel");
