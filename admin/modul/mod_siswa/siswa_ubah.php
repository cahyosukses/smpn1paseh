...
?>
<form id="defaultForm" class='form-horizontal' method='post' action='modul/mod_siswa/act.php?act=ubah' id='frm' enctype='multipart/form-data' autocomplete='off' >
	<div class="row">
      	<div class="col-lg-6">
			<div class='form-group'>
			    <label class="control-label col-lg-4">NIS</label>
			    <div class="col-lg-8">
			    	<input type='text' name='nis' class='form-control' tabindex="1" placeholder='Nomor Induk Siswa' readonly="readonly" value="<?php echo $data['nis']; ?>" />
			    </div>
			</div>
			<div class='form-group'>
			    <label class="control-label col-lg-4">Nama Lengkap</label>
			    <div class="col-lg-8">
			    	<input type='text' name='nama' class='form-control' tabindex="2" placeholder='Nama Siswa' required value="<?php echo $data['nama']; ?>" />
			    </div>
			</div>
			<div class='form-group'>
		...
		<div class="col-lg-6">
			    ...
			    <div class="col-lg-8">
	            	<div class="fileinput fileinput-new" data-provides="fileinput">
		              <div class="fileinput-new thumbnail" style="width: 200px; height: auto; min-height: 150px;">
		                <img data-src="holder.js/100%x100%" src="../directory_files/foto_siswa/<?php echo $data['foto']; ?>">
		              </div>
	              	  <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"></div>
		              <div>
		                <span class="btn btn-default btn-file"><span class="fileinput-new">Ganti Foto</span> <span class="fileinput-exists">Ganti</span> 
			...
			<div class='form-group'>
			    ...
			    <div class="col-lg-8">
			    	<input type="text" name='telepon' class='form-control' placeholder='No Telepon' tabindex="8" maxlength="12" required value="<?php echo $data['telepon']; ?>"/>
			    </div>
			</div>
			...
			<div class='form-group'>
			    ...
			    <div class="col-lg-8">
			    	<input type='email' name='email' class='form-control' required placeholder='Email' tabindex="11" value="<?php echo $data['email']; ?>"/>
				</div>
			</div>
