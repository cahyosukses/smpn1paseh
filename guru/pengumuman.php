...
<div class="grid_8 well">
	<div class="clearfix">
		<h3>Buat Pengumuman Untuk Mata Pelajaran <?php echo $dataMapel['mapel']; ?></h3>
		<div class="hr-edited hr-dashed"></div>
		<div class="grid_7">
			<!-- BEGIN CONTACT FORM -->
			<form method="post" action="../guru/act.php?act=tambah_pengumuman" id="contact-form" class="contact-form">
				<div class="field">
	...
	<div class="clearfix">
		...
		<div class="grid_7">
			<?php
				...
				$nip = $_SESSION['nip'];
				$select = mysql_query("SELECT * FROM tbl_info_pengumuman_guru WHERE nip = '$nip' ORDER BY id DESC LIMIT $posisi,$batas");
				while ($data = mysql_fetch_array($select)) {
				?>
				<!-- begin post heading -->
				<header class="entry-header clearfix">
					<div class="entry-header-inner">
						<h2 class="entry-title" align="left"><a href="#"><?php echo $data['judul'] ?></a><a href="../guru/act.php?act=hapus_pengumuman&amp;id=<?php echo $data['id']; ?>&amp;id_mapel=<?php echo $_GET['id_mapel'] ?>" onClick="return confirm('Anda yakin ingin menghapus pengumuman ini ?')" class="red" style="float:right;color:white">Hapus</a></h2>
						<p class="post-meta">
	...
	<div class="clearfix">
		<div class="grid_12">
			...
			<!-- Pagination -->
			<?php
			$tampil2=mysql_query("SELECT * FROM tbl_info_pengumuman_guru WHERE nip = '$nip'");
